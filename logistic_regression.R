...
##   having been diagnosed with hypertension, while an 63 year old female
...
# Look at all data to be used in model together
nh11.wrk.age.mar <- subset(NH11, select = c("everwrk", "age_p", "r_maritl"))
summary(nh11.wrk.age.mar)

# Need to collapse all missing values to NA for everwrk and drop unused levels from fractors for r_maritl
NH11 <-transform(NH11,
